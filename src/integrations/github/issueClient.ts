...
export interface GitHubIssueClientEnv {
...
async function createGitHubAppJwt(env: GitHubIssueClientEnv): Promise<string> {
...
async function createInstallationAccessToken(env: GitHubIssueClientEnv, apiBaseUrl: string): Promise<string> {
